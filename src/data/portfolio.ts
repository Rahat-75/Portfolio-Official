export const portfolioData = {
  ...
  skills: [
    {
      ...
      items: ["Python", "C/C++", "Java", "HTML", "CSS", "JavaScript", "TypeScript", "React", "PHP", "MySQL", "Git & GitHub", "LaTeX", "Microsoft Office"],
    },
    {
    ...
    },
    {
      ...
      items: ["Team Collaboration", "Project Management", "Research Documentation", "Academic Writing"],
    },
  ],
  ...
  experience: [
    ...
    {
      title: "Executive Member (Logistics Support)",
  ...
  publications: [
    {
      title: "LoRA-Enhanced Dual-Backbone Fusion through Multi-level Knowledge Distillation for Acute Lymphoblastic Leukemia Classification with Explainable AI",
      journal: "Scientific Reports (Nature Portfolio)",
      status: "Under Review - Q1",
      year: "2026",
      authors: "Md. Abdul Rabbi Rahat, Mehedi Hasan Salman, Md Assaduzzaman, Md. Zahid Hasan, Nafiz Fahad, and Md. Jakir Hossen",
    },
    {
      title: "Mitigating the Spread of Misinformation: A Comparative Analysis of Deep Learning Architectures for Fake News Detection",
      journal: "IEEE",
      year: "2025",
  ...
  certifications: [
    {
      ...
      date: "2025-03-31",
      grade: "100%",
      skills: ["Data Analysis", "Data Science", "Graphing", "Descriptive Statistics", "Probability", "Arithmetic", "Bayesian Statistics", "Algebra", "Calculus"],
    },
  ],

  awards: [
    {
      title: "90% Merit-Based Scholarship",
      issuer: "Daffodil International University",
      period: "2021-2025",
    },
    {
      title: "Government Merit Scholarship (SSC-2017)",
